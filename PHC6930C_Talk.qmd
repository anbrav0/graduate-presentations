...
-	Why?
    ...
    - How to present your data findings (data visualization) 
How do you want to answer your research question? (Regression? mixed- effects? Correlated data?, nested- data?)
    - Reproducibility? 
