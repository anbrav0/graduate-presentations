...
::: {.column width="50%"}
![](Picture_redcappng.png){fig-align="center" width="439"}
:::
...
::: {.column width="100%"}
![](plantonic_trend.png){fig-align="center"}
:::
...
::: {.column width="100%"}
![](manuscript_quarto_example.png){fig-align="center"}
:::
...
::: {.column width="100%"}
![individuals who reported they had a good time (non-outlier) vs. individuals who reported they did not have a good time (outlier) participating in research](stacked_bar_plot_example.png){fig-align="center"}
:::

::: {.column width="100%"}
![this was something i did for fun, checking out the distribution of 👽 sightings in America](alien_plot.png)
:::

::: {.column width="100%"}
![correlation matrix i needed to do to check out the correlation between certain items in a research study](correlation_matrix.png)
:::
...
::: {.column width="100%"}
![](random_intercept_example.png){fig-align="center"}
:::
...
-   i've had to implament every aspect of what we just talked about including
...
# columns character data - this data is in wide form
relig_income
